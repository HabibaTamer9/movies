...
fetchPopular() async{
  var response = await http.get(Uri.parse("https://api.themoviedb.org/3/movie/popular?api_key=e5ad62e9c717f4015e22c0dfc8eda432"));
...
fetchNew() async{
  var response = await http.get(Uri.parse("https://api.themoviedb.org/3/movie/now_playing?api_key=e5ad62e9c717f4015e22c0dfc8eda432"));
  if(response.statusCode == 200){
    var body = jsonDecode(response.body );
...
fetchTop() async{
  var response = await http.get(Uri.parse("https://api.themoviedb.org/3/movie/top_rated?api_key=e5ad62e9c717f4015e22c0dfc8eda432"));
  if(response.statusCode == 200){
    var body = jsonDecode(response.body );
