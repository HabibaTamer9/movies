...
class _MovieDetailsState extends State<MovieDetails> {
  ...
  getVideo() async {
    var response = await http.get(Uri.parse(
        "https://api.themoviedb.org/3/movie/${widget.movie[widget.i]["id"]}/videos?api_key=$appApi"));
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: NetworkImage(
                        "https://image.tmdb.org/t/p/w500/${widget.movie[widget.i]["backdrop_path"]}"),
                  ),
                ),
              ),
            ),
                  ...
                  children: [
                    Container(
                      ...
                      child: Wrap(
                        children: [
                          Hero(
                            tag:
                                "movie_${widget.movie[widget.i]["title"]}_${widget.listName}",
                            child: ContentText(
                          ...
                          Padding(
                            ...
                            child: ContentText(
                              text: widget.movie[widget.i]["release_date"]
                                  .toString()
                                  .substring(0, 4),
                              white: false,
                            ),
                    ...
                    Wrap(
                      children: [
                        ...
                        Padding(
                          ...
                          child: ContentText(
                            text:
                                " ${widget.genres.map((g) => g['name']).join(' , ')}",
                            white: false,
                          ),
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ContentText(
                          text:
                              "⭐  ${double.parse(widget.movie[widget.i]["vote_average"].toString()).toStringAsFixed(1)}",
                          white: true,
                        ),
                        SizedBox(
                          width: 10,
                        ...
                        ContentText(
                          text:
                              "from ${widget.movie[widget.i]["vote_count"]} users",
                          white: false,
                        ),
                      ],
                    ),
                    ...
                    ContentText(
                      text:
                          "🌍  Language : ${widget.movie[widget.i]["original_language"]}",
                      white: false,
                    ),
                    SizedBox(
                      height: height * 0.005,
                    ...
                    ContentText(
                      text: "⏱  Time : ${formatTime(widget.runtime)}",
                      white: false,
                    ),
                    SizedBox(
                      height: height * 0.04,
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xff075a61), Colors.purple],
